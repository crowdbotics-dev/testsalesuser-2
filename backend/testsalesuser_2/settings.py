"""
Django settings for testsalesuser_2 project.
...
ROOT_URLCONF = 'testsalesuser_2.urls'
...
WSGI_APPLICATION = 'testsalesuser_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testsalesuser_2 API",
    "DESCRIPTION": "API documentation for testsalesuser_2 App",
    "VERSION": "v1",
}
